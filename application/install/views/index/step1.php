        ...
        <div class="main">
            ...
            <div class="content-box">
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="0">
                    ...
                    <?php foreach ($dirfileItems as $k => $v) { ?>
                        <tr>
            ...
            <div class="btn-box">
                <a href="/install" class="btn btn-primary">上一步</a>
